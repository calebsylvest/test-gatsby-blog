module.exports = {
  ...
  siteUrl: "https://calebsylvest.github.io/", // Domain of your website without pathPrefix.
  pathPrefix: "blog", // Prefixes all links. For cases when deployed to example.github.io/gatsby-starter-casper/.
  siteDescription: "Musings of a part-time genius?", // Website description used for RSS feeds/meta description tag.
  siteCover: "./images/hero-cover.jpg", // Optional, the cover image used in header for home page. e.g: "/images/blog-cover.jpg",
  ...
  themeColor: "#f43531", // Used for setting manifest and progress theme colors.
  backgroundColor: "#f7fae1", // Used for setting manifest background color.
